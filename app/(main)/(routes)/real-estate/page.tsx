...
export default function RealEstatePage() {
  return (
    <main className="flex flex-col min-h-screen bg-white">
      {/* 1. HERO SECTION - Semantic Header handled inside component */}
      <HeroSection />
      ...
      >
        ...
        >
          ...
          >
            <div className="h-1 w-12 bg-amber-500" aria-hidden="true" />
        ...
        {/* Ensure this component uses <article> or <ul> internally */}
        <ServiceGrid />
      </section>
      ...
      >
        {/* Decorative Background Icon - Hidden from screen readers */}
        <motion.div
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="pt-4">
            <Button
              size="lg"
              variant="amber"
              className="h-16 px-12 rounded-none font-bold uppercase tracking-[0.2em] text-sm ms:text-lg shadow-xl hover:shadow-2xl transition-all focus-visible:ring-4 focus-visible:ring-amber-400"
              aria-label="Book a professional property valuation session"
            >
              Book a Consultancy Session
            </Button>
          </motion.div>

          {/* Key Metrics - Using semantic Data List */}
          <motion.dl variants={fadeInUp} className="flex gap-8 pt-8">
            <div className="flex flex-col items-center">
              <dd className="text-amber-500 text-2xl font-black">24h</dd>
              <dt className="text-blue-200 text-[10px] font-bold uppercase tracking-widest">
                Turnaround
              </dt>
            </div>
            <div className="w-px h-10 bg-blue-800" aria-hidden="true" />
            <div className="flex flex-col items-center">
              <dd className="text-amber-500 text-2xl font-black">100%</dd>
              <dt className="text-blue-200 text-[10px] font-bold uppercase tracking-widest">
                Verified
              </dt>
            </div>
